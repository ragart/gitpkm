...
def main() -> int:
    ...
    print(
        f"Export complete: {output_dir} (private ids filtered: {len(private_ids)}, private file patterns: {len(private_file_patterns)}, note policy: {args.note_policy}, assets copied: {copied_assets})"
    )
    return 0
